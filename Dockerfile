...
# Other Python image variants are available and might work for your
# use case; however, this project only supports the latest non-slim
# Debian version (trixie as of 2026-09-15). Change this only if you
